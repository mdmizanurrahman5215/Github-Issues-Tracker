const displayIssues = (array) => {
  ...
  array.forEach(issue => {
    const {title,id, description,status, labels,priority,author, assignee, createdAt, updatedAt } = issue
    ...
    <div
            ...
            >
              ...
              <div class="">
                <p class="text-xl text-gray-500"> #${id} ${assignee ? assignee : "assignee not available"}</p>
